...
| --- | --- | ---: | ---: | ---: |
| `SVGD` | `O(N^2 d)` | `0.011` | `0.909` | `0.224` |
| `RandomBatchSVGD` (`batch_size=32`) | `O(N B d)` | `0.007` | `0.724` | `0.112` |
| `SPOS` (`temperature=0.01`) | `O(N^2 d) + O(N d)` | `0.008` | `1.023` | `0.214` |

For this target, `RandomBatchSVGD` is the clear wall-clock winner while `SPOS`
lands closest to the target variance under the same update budget.

Scaling with particle count:

| Particles | `SVGD` time (s) | `RandomBatchSVGD` time (s) | `SPOS` time (s) |
| ---: | ---: | ---: | ---: |
| `128` | `0.060` | `0.059` | `0.066` |
| `256` | `0.214` | `0.114` | `0.217` |
| `512` | `0.969` | `0.221` | `0.977` |

At `512` particles, `RandomBatchSVGD` is about `4.4x` faster than full-batch
...
| Method | Steps | Per-step cost | Var(x1) | Var(x2) | Mahalanobis energy | Mean wall time (s) |
| --- | ---: | --- | ---: | ---: | ---: | ---: |
| `SVGD` | `40` | `O(N^2 d)` | `3.390` | `0.201` | `8.428` | `0.006` |
| `RandomBatchSVGD` | `40` | `O(N B d)` | `2.972` | `0.039` | `3.959` | `0.005` |
| `SPOS` | `40` | `O(N^2 d) + O(N d)` | `3.401` | `0.211` | `8.699` | `0.006` |
| `MatrixSVGD` | `40` | `O(N^2 d^2)` | `3.343` | `0.042` | `4.417` | `0.016` |
| `SteinVariationalNewton` | `6` | `O(N^2 d^2) + O(N d^3)` | `0.940` | `0.066` | `2.598` | `0.052` |
